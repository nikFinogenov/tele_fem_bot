...
def photo(update, context):
    ...
    if genders[0] == "female":
        ...
        text = random.choice(open('female','r',encoding="utf-8").readlines()) 
    else:
        # generator = get_model("male")
        text = random.choice(open('male','r',encoding="utf-8").readlines()) 
...
def main():
    updater = Updater("1683112955:AAE6LA56zG7Wykk1VJVxDqCZJznr3v33HaQ", use_context=True)
